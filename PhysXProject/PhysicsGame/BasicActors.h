...
namespace PhysicsEngine
{
	...
	public:
		Goal(const PxVec3 pose = PxVec3(0.0f, 0.5f, 50.0f), const PxVec3& dimensionsBack = PxVec3(4.0f, 0.5f, 0.25f), const PxVec3& dimensionsSides = PxVec3(0.25, 0.5f, 2.0f))
		{
			...
			left = new Rectangle(PxTransform(PxVec3(pose.x + 4.2f, pose.y, pose.z - 1.75f)), PxVec3(dimensionsSides), PxReal(1.0f));
			right = new Rectangle(PxTransform(PxVec3(pose.x - 4.2f, pose.y, pose.z - 1.75f)), PxVec3(dimensionsSides), PxReal(1.0f));
		}
